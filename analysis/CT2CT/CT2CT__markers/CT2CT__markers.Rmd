...
#counts.stitched = readRDS(paste0( root.dir, "data/8_5/stitching/pca_K10_mean__HVGs.rds") )

rownames.counts.stitched = rownames(counts.stitched)
rownames.counts.stitched = rownames.counts.stitched[!is.na(rownames.counts.stitched)]
counts.stitched = counts.stitched[rownames(counts.stitched) %in% rownames.counts.stitched,]
counts.stitched = as.matrix(counts.stitched)
