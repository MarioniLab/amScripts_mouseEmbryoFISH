---
title: "smFISH genes: assessment of the dependance between intensties and channels."
output:
...
**Discard channel 1, pos 39,40,43,44.**
...
root.dir = "/Users/alsu/Develop/spatial/mouse_embryo/amScripts_mouseEmbryoFISH/analysis/smFISH__countDots/"
figures.dir = "/Users/alsu/Develop/spatial/mouse_embryo/figures/smFISH__dotsAutoDetect/"

# load data 
manual_thresh.embryo_12 = read.table(paste0( root.dir, "manual_threshold/embryo12.tab"), header = TRUE, sep = "\t", stringsAsFactors = FALSE, comment.char = "$")
...
manual_thresh.embryo_3 = read.table(paste0( root.dir, "manual_threshold/embryo3.tab"), header = TRUE, sep = "\t", stringsAsFactors = FALSE, comment.char = "$")
...
manual_thresh.embryo_12_weird = read.table(paste0( root.dir, "manual_threshold/embryo12_channel_1_pos_39_40_43_44.tab"), header = TRUE, sep = "\t", stringsAsFactors = FALSE, comment.char = "$")
...
write.table(stat.batch_1 , file = paste0(root.dir, "mean_prediction_embryo12.tab"), row.names = F, col.names = T, sep = "\t") 
...
write.table(stat.batch_2 , file = paste0(root.dir, "mean_prediction_embryo3.tab"), row.names = F, col.names = T, sep = "\t") 
