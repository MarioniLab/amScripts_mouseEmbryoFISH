...
script=/nfs/research1/marioni/alsu/spatial/mouse_embryo/amScripts_mouseEmbryoFISH/mapping/KNN_based/celltyping/raw_markerGenes_reducedAtlas/run_rmd.R
