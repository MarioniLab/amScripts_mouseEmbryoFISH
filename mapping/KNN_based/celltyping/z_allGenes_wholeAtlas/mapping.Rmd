...
counts.seq = get_z.counts(counts.seq)
...
z.counts.atlas.bySamples = lapply(unq.samples, function(x){
  ...
  out = get_z.counts(out)
  return(out)
})
counts.atlas = do.call(cbind, z.counts.atlas.bySamples)
...
saveRDS(mapping, file = paste0( root.dir, "data/8_5/celltyping/z_allGenes_wholeAtlas__embryo1.rds"))
