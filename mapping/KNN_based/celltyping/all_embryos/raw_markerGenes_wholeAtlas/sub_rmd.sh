...
script=/nfs/research1/marioni/alsu/spatial/mouse_embryo/amScripts_mouseEmbryoFISH/mapping/KNN_based/celltyping/all_embryos/raw_markerGenes_wholeAtlas/run_rmd.R
