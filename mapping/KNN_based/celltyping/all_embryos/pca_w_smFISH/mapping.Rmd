...
load_embryo_8.5(threshTotalRNA = 0, filterNullArea = T, filterBigClumps = T, dir = "cluster", smFISH = "lower")
...
saveRDS(mapping.all, file = paste0( root.dir, "data/8_5/celltyping/pca_w_smFISH_lower_embryo12.rds"))


# UPPER
# load sce files with counts data; clean from cells with 0 area and total # mRNA < user's threshold 
load_embryo_8.5(threshTotalRNA = 0, filterNullArea = T, filterBigClumps = T, dir = "cluster", smFISH = "upper")
...
names(mapping.all) = unq.embryo
saveRDS(mapping.all, file = paste0( root.dir, "data/8_5/celltyping/pca_w_smFISH_upper_embryo12.rds"))
