...
# get knn-graph
k.neigh = 50
knns = queryKNN(atlas.corrected.pca, seq.corrected.pca, k = k.neigh, get.index = TRUE, 
...
# z-score
# get knn-graph
knns = queryKNN(z.atlas.corrected.pca, z.seq.corrected.pca, k = k.neigh, get.index = TRUE, 
                get.distance = TRUE, BPPARAM=mcparam)
