...
mappings.libsize = lapply(unq.embryo, function(x){
...
saveRDS(mappings.libsize, file = paste0( root.dir, "data/8_5/mapping/logcounts_libsize__knn.rds"))

# for counts normalized by area
mappings.area = lapply(unq.embryo, function(x){
  mapEmbryo(sce.atlas, meta.atlas, sce[, meta$embryo == x], meta[meta$embryo == x,], 
            assay.type = "logcounts.area", k = 10)
})
names(mappings.libsize) = unq.embryo
saveRDS(mappings.libsize, file = paste0( root.dir, "data/8_5/mapping/logcounts_area__knn.rds"))
