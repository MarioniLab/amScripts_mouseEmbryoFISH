...
# get embryo 1
idx = which(str_detect(names(mapping.pca), "embryo3"))
mapping.pca = mapping.pca[idx]
...
saveRDS(estimated.counts.mean, file = paste0( root.dir, "data/8_5/stitching/pca_K25_mean_embryo1.rds"))
