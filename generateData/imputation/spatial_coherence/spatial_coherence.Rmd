...
spatialCoherenceWithin = function(n.neigh){
  spatial.coherency.within_z = bplapply(colnames(sce.seq), function(current.cell){
    current.CT = meta$celltype_mapped_refined[meta$uniqueID == current.cell]
    ...
    if (!is_empty(current.adjacency.list)){
      ...
      neighbor.CT = sapply(neighbor.cells, function(x) meta$celltype_mapped_refined[meta$uniqueID == x])
  ...
  return(spatial.coherency.within_z)
}
spatial.coherency.within_z.nn_1 = spatialCoherenceWithin(1)
spatial.coherency.within_z.nn_2 = spatialCoherenceWithin(2)
spatial.coherency.within_z = list(n.neigh_1 = spatial.coherency.within_z.nn_1, 
                                  n.neigh_2 = spatial.coherency.within_z.nn_2)
...
spatialCoherenceBetween = function(n.neigh){
  ...
  return(spatial.coherency.between_z)
}
spatial.coherency.between_z.nn_1 = spatialCoherenceBetween(1)
spatial.coherency.between_z.nn_2 = spatialCoherenceBetween(2)
spatial.coherency.between_z = list(n.neigh_1 = spatial.coherency.between_z.nn_1, 
                                  n.neigh_2 = spatial.coherency.between_z.nn_2)
