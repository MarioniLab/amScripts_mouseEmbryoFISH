...
stat.mappingEntropy = lapply(1:ncol( mapping ), function(x){
  ...
  out = data.frame(cell = colnames(mapping)[x],
                   mapping.entropy = length(cells.stat))
  return(out)
})
stat.mappingEntropy = do.call(rbind, stat.mappingEntropy)
saveRDS(stat.mappingEntropy, file =  paste0( root.dir, "data/8_5/stitching/mappingEntropy_atlas2atlas.rds"))
