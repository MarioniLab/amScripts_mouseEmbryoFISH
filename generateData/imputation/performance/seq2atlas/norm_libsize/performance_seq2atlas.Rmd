...
counts.cosine.seq = as.matrix( cosineNorm(assay(sce.seq, "cpm")) )
...
saveRDS(performance.seq, file =  paste0( root.dir, "data/8_5/stitching/performance_seq2atlas_libsize.rds"))
...
stat.mappingEntropy = lapply(1:ncol( mapping ), function(x){
  ...
  out = data.frame(uniqueID = colnames(mapping)[x],
                   mapping.entropy = length(cells.stat))
  return(out)
})
stat.mappingEntropy = do.call(rbind, stat.mappingEntropy)
saveRDS(stat.mappingEntropy, file =  paste0( root.dir, "data/8_5/stitching/mappingEntropy_seq2atlas_libsize.rds"))
...
saveRDS(spatial.coherency, file =  paste0( root.dir, "data/8_5/stitching/seq_spatialCoherency_seq2atlas_libsize.rds"))
