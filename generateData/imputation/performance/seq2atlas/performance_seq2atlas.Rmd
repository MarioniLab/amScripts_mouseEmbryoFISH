...
sce.seq = sce[!rownames(sce) == "Xist", sce$embryo == "embryo1" & sce$z == 2]
...
# load mapping
mapping = readRDS(paste0( root.dir, "data/8_5/stitching/mapping_seq2atlas_s29__embryo1z2.rds"))
...
saveRDS(performance.seq, file =  paste0( root.dir, "data/8_5/stitching/performance_seq2atlas_s29__embryo1z2.rds"))
