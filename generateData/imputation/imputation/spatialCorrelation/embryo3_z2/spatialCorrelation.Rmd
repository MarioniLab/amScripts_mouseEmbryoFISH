...
meta = meta[meta$embryo_z == "embryo3_2" , ]
sce.seq = sce.seq[, colnames(sce.seq) %in% meta$uniqueID ]

# load mappings
imputation = readRDS(paste0( root.dir, "data/8_5/stitching/imputation/imputation_seq2atlas_logcounts_embryo3z2.rds"))
...
saveRDS(spatial.correlation, file =  paste0( root.dir, "data/8_5/stitching/imputation/spatialCorrelation/spatialCorrelation_embryo3z2.rds"))
