...
mapping = mapping.embryo2z5[, colnames(mapping.embryo2z5) %in% meta$uniqueID ]
...
saveRDS(gene.score, file =  paste0( root.dir, "data/8_5/stitching/geneScore_imputation_HVGs_embryo2z5.rds"))
