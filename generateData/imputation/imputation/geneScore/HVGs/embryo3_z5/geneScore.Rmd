...
HVGs = read.table(paste0(root.dir, "data/8_5/HVGs_atlas.tab"), stringsAsFactors = F)
HVGs = HVGs$V1
# load atlas 
sce.atlas = readRDS(paste0(root.dir, "data/reducedAtlas/E8_25__E8_5.rds"))
sce.atlas = sce.atlas[rownames(sce.atlas) %in% HVGs, sce.atlas$stage == "E8.5"]
...
mapping = mapping.embryo3z5[, colnames(mapping.embryo3z5) %in% meta$uniqueID ]
...
saveRDS(gene.score, file =  paste0( root.dir, "data/8_5/stitching/geneScore_imputation_HVGs_embryo3z5.rds"))
