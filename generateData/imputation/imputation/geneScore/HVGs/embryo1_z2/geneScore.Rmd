...
mapping = mapping.embryo1z2[, colnames(mapping.embryo1z2) %in% meta$uniqueID ]
...
saveRDS(gene.score, file =  paste0( root.dir, "data/8_5/stitching/geneScore_imputation_HVGs_embryo1z2.rds"))
