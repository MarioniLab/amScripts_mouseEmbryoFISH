...
mapping = mapping.embryo2z2[, colnames(mapping.embryo2z2) %in% meta$uniqueID ]
...
saveRDS(gene.score, file =  paste0( root.dir, "data/8_5/stitching/geneScore_imputation_HVGs_embryo2z2.rds"))
