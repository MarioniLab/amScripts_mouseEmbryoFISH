...
gene.score = lapply(unq.embryo , function(embryo){
  gene.score.per_embryo = lapply(unq.z , function(z){
    ...
    return(gene.score.per_embryo_z)
  })
  gene.score.per_embryo = do.call(rbind , gene.score.per_embryo)
  return(gene.score.per_embryo)
})
gene.score = do.call(rbind , gene.score)
saveRDS(gene.score, file =  paste0( root.dir, "data/8_5/stitching/imputation/geneScore/geneScore_imputation_filtered.rds"))
