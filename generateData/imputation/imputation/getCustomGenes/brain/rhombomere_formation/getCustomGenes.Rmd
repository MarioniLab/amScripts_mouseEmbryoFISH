...
# genes2keep
rhombomere_markers = read.table(paste0( root.dir, "amScripts_mouseEmbryoFISH/generateData/imputation/imputation/getCustomGenes/brain/rhombomere_formation/rhombomere_markers.tab"), header = TRUE, sep = "\t", stringsAsFactors = FALSE, comment.char = "$")
genes2keep = rhombomere_markers$Gene
...
saveRDS(imputation.custom, file = paste0( root.dir, "data/8_5/stitching/imputation/custom/imputation_Rhombomere.rds"))  
