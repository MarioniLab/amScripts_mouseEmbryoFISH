...
getLogcountsSE = function(cells, weights){ 
  ...
  current.counts.expanded = rep(current.counts, times = weights)
  current.counts.se = stderr(current.counts.expanded)
...
saveRDS(logcounts.imputation_se.seq, file =  paste0( root.dir, "data/8_5/stitching/imputation/imputation_seq2atlas_logcounts_se_embryo3z5.rds"))
