...
idx = meta$embryo == "embryo2" & meta$z == 5
...
saveRDS(mapping, file =  paste0( root.dir, "data/8_5/stitching/mapping_seq2atlas_embryo2z5_libsize.rds"))
...
mapping = do.call(rbind, mapping )
colnames(mapping) = colnames(sce.seq)
saveRDS(mapping, file =  paste0( root.dir, "data/8_5/stitching/mapping_seq2atlas_embryo2z5_area.rds"))
