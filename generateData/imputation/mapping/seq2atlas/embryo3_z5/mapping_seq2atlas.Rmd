...
saveRDS(mapping, file =  paste0( root.dir, "data/8_5/stitching/mapping_seq2atlas_embryo3z5_libsize.rds"))
...
mapping = do.call(rbind, mapping )
colnames(mapping) = colnames(sce.seq)
saveRDS(mapping, file =  paste0( root.dir, "data/8_5/stitching/mapping_seq2atlas_embryo3z5_area.rds"))
