...
idx = meta$embryo == "embryo1" & meta$z == 5
...
assay(sce.seq, "cosineNorm_cpm") <- cosineNorm(assay(sce.seq, "cpm"))
...
saveRDS(mapping, file =  paste0( root.dir, "data/8_5/stitching/mapping_seq2atlas_embryo1z5_libsize.rds"))
...
mapping = do.call(rbind, mapping )
colnames(mapping) = colnames(sce.seq)
saveRDS(mapping, file =  paste0( root.dir, "data/8_5/stitching/mapping_seq2atlas_embryo1z5_area.rds"))
