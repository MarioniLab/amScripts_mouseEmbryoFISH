...
counts.binary.seq.denoised_2 = denoisingBinaryCounts(counts.cosine.seq, meta, neigh.net, 2, "mean", mcparam)
...
counts.binary.imputed.denoised_1 = denoisingBinaryCounts(counts.binary.imputed, meta, neigh.net, 1, mcparam)
counts.binary.imputed.denoised_2 = denoisingBinaryCounts(counts.binary.imputed, meta, neigh.net, 2, mcparam)
...
counts.cosine.imputed.denoised_1 = denoisingCounts(counts.cosine.imputed, meta, neigh.net, 1, "mean", mcparam)
counts.cosine.imputed.denoised_2 = denoisingCounts(counts.cosine.imputed, meta, neigh.net, 2, "mean", mcparam)
...
performance.seq = list(counts.binary.seq = counts.binary.seq,
                       ...
                       counts.binary.imputed = counts.binary_mode.imputed,
