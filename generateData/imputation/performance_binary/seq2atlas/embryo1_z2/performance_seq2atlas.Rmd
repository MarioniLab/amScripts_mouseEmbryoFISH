...
counts.cosine.seq.denoised_1 = denoisingCounts(counts.cosine.seq, meta, neigh.net, 1, "mean", mcparam)
counts.cosine.seq.denoised_2 = denoisingCounts(counts.cosine.seq, meta, neigh.net, 2, "mean", mcparam)
...
# imputed-cosine-q75
counts.cosine.imputed.q75 = bplapply(genes, function(current.gene){
  ...
  avg.imputed = sapply(1:ncol(current.mapping), function(x){
    return( quantile( current.atlas[current.mapping[,x]] , 0.75) )
  })
  return(avg.imputed)
}, BPPARAM = mcparam)
counts.cosine.imputed.q75 = do.call(rbind, counts.cosine.imputed.q75)
colnames(counts.cosine.imputed.q75) = colnames(mapping)
rownames(counts.cosine.imputed.q75) = genes

counts.cosine.imputed.q75.denoised_1 = denoisingCounts(counts.cosine.imputed.q75, meta, neigh.net, 1, "mean", mcparam)
counts.cosine.imputed.q75.denoised_2 = denoisingCounts(counts.cosine.imputed.q75, meta, neigh.net, 2, "mean", mcparam)
...
counts.cosine.imputed.median.denoised_1 = denoisingCounts(counts.cosine.imputed.median, meta, neigh.net, 1, "mean", mcparam)
counts.cosine.imputed.median.denoised_2 = denoisingCounts(counts.cosine.imputed.median, meta, neigh.net, 2, "mean", mcparam)
...
counts.cosine.imputed.mean.denoised_1 = denoisingCounts(counts.cosine.imputed.mean, meta, neigh.net, 1, "mean", mcparam)
counts.cosine.imputed.mean.denoised_2 = denoisingCounts(counts.cosine.imputed.mean, meta, neigh.net, 2, "mean", mcparam)
...
counts.cosine.imputed.max.denoised_1 = denoisingCounts(counts.cosine.imputed.max, meta, neigh.net, 1, "mean", mcparam)
counts.cosine.imputed.max.denoised_2 = denoisingCounts(counts.cosine.imputed.max, meta, neigh.net, 2, "mean", mcparam)
...
performance.seq = list(
                       ...
                       counts.cosine.imputed.q75 = counts.cosine.imputed.q75,
                       counts.cosine.imputed.q75.denoised_1 = counts.cosine.imputed.q75.denoised_1,
                       counts.cosine.imputed.q75.denoised_2 = counts.cosine.imputed.q75.denoised_2,
