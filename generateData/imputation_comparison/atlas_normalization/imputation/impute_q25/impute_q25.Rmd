---
title: "Pipeline to imputate from atlas (q25)."
output:
...
estimated.counts = lapply(1:length(mapping), function(y){
  estimated.counts.per_nPC = lapply(n.neigh, function(current.n){
    ...
    saveRDS(estimated.counts.per_nPC.per_nn, 
            file =  paste0( root.dir, "data/8_5/stitching/compareMetrics/atlas_onto_atlas/nn_", current.n, "__n", names(mapping)[y], "__q25.rds"))
  })
})
